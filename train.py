...
ap.add_argument("-m", "--model", type=str, default="weights.model",
...
# augmenting datset 
aug = ImageDataGenerator(rotation_range=50, width_shift_range=0.2,
                         height_shift_range=0.2, shear_range=0.3, zoom_range=0.4,
                         horizontal_flip=True, vertical_flip=True, fill_mode="nearest")

# build model
model = VGGNet.build(width=img_dims[0], height=img_dims[1], depth=img_dims[2],
                            classes=2)
